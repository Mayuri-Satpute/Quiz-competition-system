...
public class Quiz extends JFrame implements ActionListener{
	...
	String userarray[][]=new String[10][1];
	JLabel qno,question;
	...
	String name; //globally
	 Quiz(String name)
	 {
		 ...
		 question=new JLabel();
		 question.setBounds(150,200,950,30);
...
////////////////////////////////////////////////////////////	
    ...
    opt1.setBounds(170,250,700,30);
    opt1.setBackground(Color.white);
    opt1.setFont(new Font("Dialog",Font.PLAIN,20));
     add(opt1);
      
      opt2= new JRadioButton();
     opt2.setBounds(170,290,700,30);
     ...
     opt2.setFont(new Font("Dialog",Font.PLAIN,20));
      ...
      opt3.setBounds(170,330,700,30);
      opt3.setBackground(Color.white);
      opt3.setFont(new Font("Dialog",Font.PLAIN,20));
       add(opt3);
       
        opt4= new JRadioButton();
       opt4.setBounds(170,370,700,30);
       ...
       opt4.setFont(new Font("Dialog",Font.PLAIN,20));
		...
		next.setBounds(1000,240,100,40);
		...
		lifeline.setBounds(1000,320,100,40);
		...
		submit.setBounds(1000,400,100,40);
	 ...
	 public void actionPerformed(ActionEvent e) {
	 	...
	 	if( groupoption.getSelection()==null)
    	{
    		...
    		userarray[count][0]= groupoption.getSelection().getActionCommand();
    	}
		...
		userarray[count][0]= groupoption.getSelection().getActionCommand();
			    ...
			    {
			   if(userarray[i][0].equals(answers[i][1]))	
			    {
			    score +=10;	
			    }else {
			  	score +=0;
	 ...
	 public void paint(Graphics g)
	 {
		 ...
		 g.setFont(new Font("tahom",Font.BOLD,20));
		 g.setColor(Color.red);
		  ...
		  }else
		  {
		   ...
		   try {
			   Thread.sleep(1000);
			   repaint(); //after 1 second decrease time
		   }catch(Exception e) {
			   e.printStackTrace();
		   }
		    if(ans_given==1) 
